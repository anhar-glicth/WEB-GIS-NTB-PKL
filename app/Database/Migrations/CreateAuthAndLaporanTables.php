...
class CreateAuthAndLaporanTables extends Migration
{
    public function up()
    {
        // --- Buat tabel users dan tabel-tabel auth lainnya ---
        // Users
        $this->forge->addField([
        ...
        $this->forge->addField([
            ...
            'status'      => ['type' => 'ENUM', 'constraint' => ['pending', 'acc', 'tolak'], 'default' => 'pending'],
            'created_at'  => ['type' => 'DATETIME', 'null' => true],
            'updated_at'  => ['type' => 'DATETIME', 'null' => true],
        ]);
        $this->forge->addKey('id', true);
